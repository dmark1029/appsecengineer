...
export default {
  ...
  async created() {
    ...
    this.user.first_name = userData.family_name
    this.user.last_name = userData.given_name
  },
  computed: {
    ...mapGetters('userDetails', ['fetchErrorMsgs'])
  },
  methods: {
    ...mapActions('userDetails', ['changeUserDetails']),
    onSubmit() {
      const data = {
