...
const fetchLearningPathsCountsGetter = computed(() => learningPathStore.fetchLearningPathsCountsGetter)
const learningPathList = computed(() => learningPathStore.learningPathList)
const searchByNameGetter = computed(() => learningPathStore.searchByNameGetter)
const searchFireActive = computed(() => learningPathStore.searchFireActive)
const fetchlistPlans = computed(() => learningPathStore.fetchlistPlans)
