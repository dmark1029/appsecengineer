...
const fetchErrorMsgs = computed(() => instructorStore.fetchErrorMsgs)
const fetchStatusOfApi = computed(() => instructorStore.fetchStatusOfApi)
...
async function onSubmit() {
  ...
  if (props.id) {
    ...
    const instructor = fetchlistInstructors.value.find((item) => item.id === this.id)
