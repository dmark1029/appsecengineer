    ...
    <div class="row text-subtitle2 q-pa-sm">
      ...
      <div class="col-md-10 col-sm-10 col-xs-10 cursor-pointer" @click="moveToDetailedInfo(data)">
        <div class="text-caption">
          <q-chip v-if="data.subscriptionType" size="sm" text-color="dark">
            {{ data.subscriptionType }}
          </q-chip>
          <q-chip v-if="expired" outline size="sm" :color="expired ? 'red' : 'green'" text-color="dark">
...
export default {
  ...
  methods: {
    moveToDetailedInfo(data) {
      this.$emit('viewCompanyInfo')
    },
