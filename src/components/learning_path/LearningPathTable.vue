...
const instructorPathPaginationKeyForward = computed(() => learningPathStore.instructorPathPaginationKeyForward)
const isLoading = computed(() => learningPathStore.isLoading)
