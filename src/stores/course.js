...
export const useCourseStore = defineStore('courseStore', () => {
  ...
  function LIST_NON_EVENT_COURSES(data) {
    const prev = listNonEventCourses.value
    listNonEventCourses.value = prev.concat(data)
  }
  ...
  async function fetchInstructionDirectory({ commit }) {
    LOADING(true)
    await api
  ...
  async function moveCourseToProdVerify({ state, commit }, payload) {
    LOADING(true)
    await api
  ...
  async function moveCourseToProdSubmit({ state, commit }, payload) {
    LOADING(true)
    await api
